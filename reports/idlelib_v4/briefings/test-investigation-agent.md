...
## Bug-shape templates for `test-investigation-agent` (1)
...
## Confirmed in OTHER projects (3) — hunt them here
...
- [coveragepy] **CRF-COVPY-0046** [FIX] Dynamic-context detection is unguarded on the default 3.14 core — `context.py:49, tests/testenv.py, pyproject.toml:121` · shape `over-broad-test-flag-mutes-instead-of-narrowing`
- [coveragepy] **CRF-COVPY-0049** [CONSIDER] CAN_MEASURE_BRANCHES is a version fact applied as a core fact — `tests/testenv.py:43` · shape `over-broad-test-flag-mutes-instead-of-narrowing`
- [coveragepy] **CRF-COVPY-0050** [CONSIDER] SwitchContextTest is skipped wholesale on sysmon though two thirds of it is core-independent — `tests/test_api.py:739` · shape `over-broad-test-flag-mutes-instead-of-narrowing`

Shapes represented above, in catalog terms: `over-broad-test-flag-mutes-instead-of-narrowing`

_82 further cross-project finding(s) were omitted here because they belong to shapes another agent owns._
