...
## Bug-shape templates for `complexity-simplifier` (1)
...
- [coveragepy] **CRF-COVPY-0022** [CONSIDER] Three sysmon callbacks index code_infos unguarded where their sibling checks — `sysmon.py:410, :436, :451` · shape `guarded-twin-with-false-reasoning`

Shapes represented above, in catalog terms: `guarded-twin-with-false-reasoning`

_84 further cross-project finding(s) were omitted here because they belong to shapes another agent owns._
