...
## Bug-shape templates for `project-docs-auditor` (3)
...
- [coveragepy] **CRF-COVPY-0056** [CONSIDER] The --rcfile help text omits .coveragerc.toml, and cog has baked it into ten doc files — `cmdline.py:299-303` · shape `generated-doc-propagates-a-source-error`
- [coveragepy] **CRF-COVPY-0057** [CONSIDER] Two config options are implemented and tested but documented nowhere — `config.py:437, :441` · shape `implemented-but-undocumented-option`
...
Shapes represented above, in catalog terms: `documented-recipe-not-wired-up`, `generated-doc-propagates-a-source-error`, `implemented-but-undocumented-option`
