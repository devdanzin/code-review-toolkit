...
Shapes represented above, in catalog terms: `conflict-resolved-silently-where-siblings-warn`, `identity-by-id-requires-retention`

_95 further cross-project finding(s) were omitted here because they belong to shapes another agent owns._
