...
## Bug-shape templates for `silent-failure-hunter` (8)
...
Shapes represented above, in catalog terms: `commit-side-effect-outside-the-success-guard`, `empty-result-conflated-with-absent`, `per-redraw-binding-never-released`, `unchecked-no-op-sentinel`

_93 further cross-project finding(s) were omitted here because they belong to shapes another agent owns._
