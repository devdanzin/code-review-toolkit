...
## Bug-shape templates for `test-investigation-agent` (2)
...
## Confirmed in OTHER projects (2) — hunt them here
...
Shapes represented above, in catalog terms: `assertion-against-a-stub-that-cannot-fail`

_96 further cross-project finding(s) were omitted here because they belong to shapes another agent owns._
